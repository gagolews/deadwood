...
class deadwood_build_ext(build_ext):
...
with open("deadwood/__init__.py", "r", encoding="utf8") as fh:
...
setuptools.setup(
    name="deadwood",
    version=__version__,
    description="Deadwood: Outlier Detection via Pruning Mutual Reachability Minimum Spanning Trees",
    ...
    project_urls={
        ...
        "Documentation":      "https://deadwood.gagolewski.com/",
        "Source Code":        "https://github.com/gagolews/deadwood",
    ...
    cmdclass={
        "sdist": deadwood_sdist,
        "build_ext": deadwood_build_ext
    },
    ext_modules=[
