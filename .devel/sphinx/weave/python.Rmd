...
```{python py_z2_dataset,fig.cap="The z2 dataset"}
...
```{python py_z2_deadwood,fig.cap="Outlier detection on z2"}
...
```{python py_z2_lumbermark,fig.cap="Detected clusters of z2"}
import lumbermark
...
```{python py_z2_lumbermark_deadwood,fig.cap="Outlier detection on clusters of z2"}
